...
family = [
    ...
    adapter.load(
        "CLE_PILOT_I/helium/delta/delta_qmi_spectrum.csv",
        column=0,
        has_header=True,
        encoding_id="delta_qmi_spectrum",
        system_id="helium",
        domain="atomic",
    ),

    adapter.load(
        "CLE_PILOT_I/helium/delta/delta_qmi_gap.csv",
        column=0,
        has_header=True,
        encoding_id="delta_qmi_gap",
        system_id="helium",
        domain="atomic",
    ),

    adapter.load(
        "CLE_PILOT_I/helium/delta/delta_qmi_preprocessed.csv",
        column=0,
        has_header=True,
        encoding_id="delta_qmi_preprocessed",
        system_id="helium",
        domain="atomic",
    ),

    adapter.load(
        "CLE_PILOT_I/helium/delta/delta_zeeman.csv",
        column=0,
        has_header=True,
        encoding_id="delta_zeeman",
        system_id="helium",
        domain="atomic",
    ),
    ...
    adapter.load(
        ...
        column=0,
        has_header=True,
        encoding_id="delta_zeeman_singlet",
        system_id="helium",
        domain="atomic",
    ),
    ...
    adapter.load(
        ...
        column=0,
        has_header=True,
        encoding_id="delta_zeeman_triplet",
        system_id="helium",
        domain="atomic",
    ),
]
