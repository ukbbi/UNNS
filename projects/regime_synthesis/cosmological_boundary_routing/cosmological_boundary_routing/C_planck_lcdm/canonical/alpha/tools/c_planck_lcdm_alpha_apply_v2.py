...
Dataset C alpha-application / deformation-grid constructor, VERSION 2, for
...
DEFAULT_GRID = DEFAULT_ALPHA_ROOT / "grids" / "C_PLANCK_LCDM_alpha_grid_v2.csv"
DEFAULT_VECTOR = DEFAULT_ALPHA_ROOT / "vectors" / "C_PLANCK_LCDM_5d_vector_v2.csv"
DEFAULT_SUMMARY = (
    DEFAULT_ALPHA_ROOT
    / "summaries"
...
def compute_vector(
    ...
    notes = (
        "Dataset C cosmological alpha vector, version 2; "
