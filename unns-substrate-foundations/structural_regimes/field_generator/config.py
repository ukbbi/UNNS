...
# ==============================
# MODE SWITCH (ONE LINE CONTROL)
# ==============================
MODE = os.environ.get("UNNS_MODE", "phase")  
# "phase"  → original 17×17 grid
# "break"  → α sweep for breakdown
...
if MODE == "phase":
    ...
    MU_GRID    = np.linspace(0.95, 1.05, 21)
